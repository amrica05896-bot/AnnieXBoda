...
# Compatible Turbo YouTube Resolver (2026)
# Optimization: Web Client Only (Cookie Safe), Skip Page Parsing, high-concurrency
...
def _normalize_link(link: str, videoid: Union[bool, str, None] = None) -> str:
    # 🛑 Safety Filter: Prevent 'True' videoid bug
...
class YouTubeAPI:
    def __init__(self):
        ...
        self.impersonate = None # Disabled to respect cookies strictness
    ...
    async def track(self, link: str, videoid: Union[bool, str, None] = None) -> Tuple[Dict[str, Any], str]:
        ...
        def _fetch_meta():
            opts = {
                ...
                # 🛑 Optimization: Skip heavy parsing, BUT stick to 'web' client for cookie safety
